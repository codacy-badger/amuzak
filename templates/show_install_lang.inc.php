...
?>
        ...
        <div class="jumbotron">
            <h1 id="headerlogo"><img src="<?php echo $web_path . AmpConfig::get('theme_path') . '/images/amuzak-' . AmpConfig::get('theme_color') . '.png' ; ?>" title="Ampache" alt="Ampache"><?php echo T_('Ampache Installation'); ?></h1>
        </div>
