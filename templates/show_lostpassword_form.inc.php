            ...
            <div id="header"><!-- This is the header -->
                <h1 id="headerlogo">
                    <a href="<?php echo $web_path ?>/login.php">
                        <img src="<?php echo $web_path ?><?php echo AmpConfig::get('theme_path'); ?>/images/amuzak.png" title="<?php echo AmpConfig::get('site_title'); ?>" alt="<?php echo AmpConfig::get('site_title'); ?>" />
                    </a>
                </h1>
            </div>
            <div id="loginbox">
