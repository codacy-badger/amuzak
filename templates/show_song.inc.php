...
<dt class="<?php echo $rowparity; ?>"><?php echo T_('Action'); ?></dt>
    ...
    ?>
        ...
        <?php if (($song->user_upload > 0 && $song->user_upload == User::get_user_id()) || Access::check('interface', '50')) {
        ?>
        ...
        <?php if (Access::check('interface', '50') || ($song->user_upload == User::get_user_id() && AmpConfig::get('upload_allow_edit'))) {
        ?>
        ...
        <?php if (Access::check('interface', '75') || ($song->user_upload == User::get_user_id() && AmpConfig::get('upload_allow_edit'))) {
        ?>
