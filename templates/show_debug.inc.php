...
<?php UI::show_box_top(T_('Debug Tools'), 'box box_debug_tools'); ?>
    ...
    <?php UI::show_box_top(T_('aMuzak Update'), 'box'); ?>
        <div><?php echo T_('Installed aMuzak version'); ?>: <?php echo AutoUpdate::get_current_version(); ?>.</div>
        <div><?php echo T_('Latest aMuzak version'); ?>: <?php echo AutoUpdate::get_latest_version(); ?>.</div>
